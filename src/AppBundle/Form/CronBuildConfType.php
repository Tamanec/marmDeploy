...
/**
 * Форма для получения данных сборки образов cron
 *
 * @package AppBundle\Form
 */
class CronBuildConfType extends AbstractType {
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefault('data_class', 'AppBundle\Model\BuildConf\CronBuildConf');
    }
